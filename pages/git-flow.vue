<template>
  <article>
    <title-slug
      title="Git Flow"
      description="
      No worry if our company does not have solid workflow yet. After working for different companies, I cab see what's ultimately working now.
    ...
    data () {
      return {
        issue: [
          ...
          'Describe what is not obvious from visual prototype - eg UX features',
        ...
        codeReview: [
          ...
          'Reviewer sends request for change or approves changes',
        ],
      }
    },
  }
